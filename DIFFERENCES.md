...
- A field HM can be used when the corresponding HM item is in the Bag, even when no party Pokémon knows the move.

The following vanilla rules remain in effect:

- Required badges are still required.
